...
const BlogSEO = ({ post, lang, isList }: BlogSEOProps) => {
  ...
  const image = post.featured_image || `https://lgueucxznbqgvhpjzurf.supabase.co/storage/v1/object/public/oven-gallery/site/vesuviano-social-banner.jpg`;
  ...
  const articleSchema = {
    ...
    publisher: {
      ...
      logo: { '@type': 'ImageObject', url: `https://lgueucxznbqgvhpjzurf.supabase.co/storage/v1/object/public/oven-gallery/site/255a7344-f5ab-411b-8b37-6ed61e01d472.png` },
    },
